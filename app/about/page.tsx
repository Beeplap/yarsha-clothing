...
export default function AboutPage() {
  return (
    <div className="about-page" style={{ background: 'var(--navy)', color: 'var(--background)', overflow: 'hidden' }}>
      ...
      <section className="about-hero noise-overlay hero-grid-bg" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center', position: 'relative' }}>
        <div className="about-hero__gradient" style={{ position: 'absolute', top: '20%', width: '600px', height: '600px', background: 'radial-gradient(circle, rgba(184, 106, 44, 0.15) 0%, transparent 70%)', filter: 'blur(60px)', zIndex: 0 }} aria-hidden="true" />
        
        <div className="about-hero__content" style={{ position: 'relative', zIndex: 10, padding: '0 2rem' }}>
          <div style={{ display: 'inline-block', padding: '8px 16px', background: 'rgba(184, 106, 44, 0.1)', border: '1px solid rgba(184, 106, 44, 0.3)', borderRadius: '30px', color: 'var(--accent)', fontSize: '0.85rem', fontWeight: 600, letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '2rem' }}>
            The Yarsha Vision
          </div>
          <h1 className="about-hero__title" style={{ fontSize: 'clamp(3rem, 8vw, 6rem)', fontWeight: 900, lineHeight: 1.1, textTransform: 'uppercase', marginBottom: '1.5rem' }}>
            ...
            <br />
            <span style={{ backgroundImage: 'linear-gradient(90deg, var(--accent), #e88942)', WebkitBackgroundClip: 'text', color: 'transparent', filter: 'drop-shadow(0 0 20px rgba(184, 106, 44, 0.3))' }}>Fashion</span>
          </h1>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', flexWrap: 'wrap', gap: '4rem' }}>
          ...
          <div className="about-story__visual-wrapper" style={{ flex: '1 1 400px', height: 'fit-content' }}>
            <div style={{ position: 'relative', padding: '4rem', background: 'rgba(255,255,255,0.02)', borderRadius: '2rem', border: '1px solid rgba(255,255,255,0.05)', overflow: 'hidden' }}>
              <div style={{ position: 'absolute', top: '-50%', left: '-50%', width: '200%', height: '200%', background: 'conic-gradient(from 0deg, transparent, rgba(184, 106, 44, 0.1), transparent)', animation: 'spin 10s linear infinite' }} />
              <div style={{ position: 'absolute', inset: '1px', background: 'var(--navy)', borderRadius: '2rem', zIndex: 1 }} />
              ...
              <div style={{ position: 'relative', zIndex: 2, display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                ...
                <h3 style={{ fontSize: '2rem', fontWeight: 600, color: 'var(--accent)' }}>Genesis</h3>
      ...
      <section className="about-values-section" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', background: 'var(--navy)', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)', overflow: 'hidden', padding: '6rem 0' }}>
          ...
          <div className="about-values__container" style={{ width: '100%' }}>
            <div className="about-values__scroll-wrapper" style={{ display: 'flex', gap: '3rem', width: 'max-content', paddingRight: '4rem' }}>
              ...
              <div style={{ width: '500px', height: '400px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '2rem', padding: '3rem', display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ width: '60px', height: '60px', background: 'rgba(184, 106, 44, 0.1)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--accent)', marginBottom: 'auto' }}>
      ...
      <section className="about-vision" style={{ padding: '12rem 2rem', textAlign: 'center', position: 'relative' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '100%', height: '100%', background: 'radial-gradient(circle, rgba(184, 106, 44, 0.05) 0%, transparent 60%)', zIndex: 0, pointerEvents: 'none' }} />
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <blockquote style={{ margin: 0 }}>
            ...
            <footer style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem' }}>
              <span style={{ width: '40px', height: '2px', background: 'var(--accent)', display: 'block', marginBottom: '1rem' }} />
      ...
      {/* CTA Section */}
      <section className="about-cta" style={{ padding: '8rem 2rem', textAlign: 'center', position: 'relative', background: 'var(--navy)' }}>
        <div className="glow-divider" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '1px', background: 'rgba(255,255,255,0.1)' }}>
          <div className="glow-divider-line" style={{ width: '100%', height: '100%', background: 'linear-gradient(90deg, transparent, var(--accent), transparent)', boxShadow: '0 0 20px rgba(184, 106, 44, 0.5)' }} />
        </div>
        ...
        <div style={{ maxWidth: '600px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <Link href="/products" className="magnetic-btn" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', background: 'var(--background)', color: 'var(--foreground)', padding: '1.25rem 3rem', borderRadius: '3rem', fontSize: '1.1rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', transition: 'all 0.3s' }}>
            Shop Now
