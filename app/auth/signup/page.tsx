        ...
        <div className="auth-card">
          <div className="auth-header">
            ...
            <p className="auth-subtitle">
              ...
              <strong>{email}</strong>. Click it to activate your account and claim your <strong>100 YarshaClub Points</strong>.
            </p>
          </div>
    ...
    <div className="auth-page">
      <div className="auth-card">
        <div className="auth-header">
          ...
          <div style={{ display: "inline-flex", alignItems: "center", gap: "6px", backgroundColor: "rgba(234, 179, 8, 0.15)", color: "#ca8a04", padding: "4px 12px", borderRadius: "20px", fontSize: "0.75rem", fontWeight: 800, marginBottom: "0.5rem" }}>
            <Sparkles size={14} /> 🎁 100 Welcome Points Included
          </div>
          <h1 className="auth-title">Join YarshaClub</h1>
          <p className="auth-subtitle">Free shipping, points on every order & daily rewards</p>
        </div>
        ...
        <form onSubmit={handleSignUp} className="auth-form">
          ...
          >
            {loading ? (
              ...
              "Join YarshaClub (Get 100 Points)"
            )}
          </button>
        </form>
